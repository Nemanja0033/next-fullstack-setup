...
export default function Page() {
  return (
    <div className="flex w-full justify-center relative left-7 md:left-0 items-center h-screen">
      <motion.div initial={{ x: -50, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 0.50 }} className="grid md:text-start text-center md:place-items-start place-items-center gap-4 p-4">
        ...
        <Link href="https://github.com/Nemanja0033/next-fullstack-setup">
          <Button size={'lg'} variant={'outline'} >Clone repo<Github /></Button>
        </Link>
      </motion.div>
      
      <div className="flex gap-4 items-center justify-center relative md:top-3 top-58 md:right-48 right-48">
